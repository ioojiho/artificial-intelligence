    ...
    while not frontier.isEmpty():
        ...
        for successor in problem.getSuccessors(currState):
            if successor[0] not in explored:
                frontier.push((successor[0], currPath+ [successor[1]]))
        ...
        for successor in problem.getSuccessors(currState):
            ...
            for node in frontier.list:
                if node[0] == successor[0]:
                    inFrontier = True
                    break
            if successor[0] not in explored and not inFrontier:
                frontier.push((successor[0], currPath + [successor[1]]))
...
def uniformCostSearch(problem):
    ...
    frontier.push((currPath, currState), 0)
    explored = set()

    while not frontier.isEmpty():
        currPath, currState = frontier.pop()
...
#                frontier.push((newPath, nextState), newCost)
        for successor in problem.getSuccessors(currState):
            if successor[0] not in explored:
                newPath = currPath + [successor[1]]
                newCost = problem.getCostOfActions(newPath)
                frontier.push((newPath, successor[0]), newCost)
